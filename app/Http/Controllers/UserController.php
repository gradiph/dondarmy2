...
class UserController extends Controller
{
    ...
    public function postTambah(UserTambahRequest $valid)
    {
        if ($valid)
        {
            ...
            User::create($data);
            return Redirect::to('user')->with('message',"Data ".Input::get('nama')." berhasil diinputkan!");
        }
    }
    ...
    public function postUbah(UserUbahRequest $valid)
    {
        if($valid)
        {
            ...
            return Redirect::to('user')->with('message','Data '.Input::get('nama').' berhasil diubah.');
        }
    }
    ...
    public function postHapus()
    {
        ...
        return Redirect::to('user')->with('message','Data '.Input::get('nama').' berhasil dihapus.');
    }
}
