...
<html lang="en">
    ...
    <body>
        <header>
            ...
            <img src="{{asset('images/poster20161127.jpg')}}" class="hero-images" alt="poster.jpg" />
        </header>
        <div id="waktu" class="container-fluid text-center bg-danger">
            <p></p>
            <div class="col-lg-offset-4 col-lg-4">
                <img src="{{asset('images/calendar-flat.png')}}" class="img-responsive" width="170" align="center">
                <h1><strong>27 November 2016</strong></h1>
            </div>
            <p></p>
            <div class="col-lg-offset-4 col-lg-4">
                <img src="{{asset('images/clock-icon.png')}}" class="img-responsive" width="170" align="center">
        ...
        <div id="tempat" class="container-fluid text-center bg-success">
            <br>
            <div class="col-lg-offset-4 col-lg-4">
                <img src="{{asset('images/place-icon.png')}}" class="img-responsive" width="170" align="center">
