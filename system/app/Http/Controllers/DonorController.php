...
//            if (Input::get('donor_terakhir') != "") $data += Input::get('donor_terakhir');
            Donor::create($data);
            return Redirect::to('admin/donor')->with('message',"Data ".Input::get('nama')." berhasil diinputkan!");
        }
    }
    ...
    public function postUbah(DonorUbahRequest $valid)
    {
        if($valid)
        {
            ...
            return Redirect::to('admin/donor')->with('message','Data '.Input::get('nama').' berhasil diubah.');
        }
    }
    ...
    public function postHapus()
    {
        ...
        return Redirect::to('admin/donor')->with('message','Data '.Input::get('nama').' berhasil dihapus.');
    }
}
