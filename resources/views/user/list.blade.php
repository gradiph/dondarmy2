<div class="table-responsive">
    <table class="table table-bordered table-striped table-hover text-center">
        <thead>
            ...
            <td>
                <a onclick="javascript:ajaxLoad('user/list?field=nama&sort={{Session::get("user_sort")=="asc"?"desc":"asc"}}','data')" href="#">
                    Nama
                </a>
            ...
            <td>
                <a onclick="javascript:ajaxLoad('user/list?field=role&sort={{Session::get("user_sort")=="asc"?"desc":"asc"}}','data')" href="#">
                    Role
                </a>
                <i style="font-size: 12px"
        ...
        <tbody>
            ...
            @foreach($users as $user)
                <tr>
                    ...
                    <td>{{ $user->role }}</td>
                    <td>
                        <a href="{{ url('user/ubah?id='.$user->id) }}" title="Ubah Data" class="btn btn-xs btn-warning"><i class="glyphicon glyphicon-edit"></i> Ubah</a>
                        <a href="{{ url('user/hapus?id='.$user->id) }}" title="Hapus Data" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-trash"></i> Hapus</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
